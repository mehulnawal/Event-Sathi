...
export default function HeroSection() {
  ...
  return (
    <section className="relative z-10 w-full max-w-[1440px] mx-auto h-full flex flex-col justify-between flex-grow px-6 md:px-12 lg:px-[72px] pt-5 md:pt-28 lg:pt-15 pb-5 md:pb-10">
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto h-full flex flex-col justify-between flex-grow px-6 md:px-12 lg:px-[72px] pt-24 md:pt-28 lg:pt-32 pb-20 md:pb-12">
        <div className="flex flex-col justify-center h-full items-center w-full gap-8 lg:gap-0">
          {/* Content panel */}
          <div className="col-span-1 flex flex-col justify-center text-left h-full w-full">
            {/* Top Label */}
            <motion.p
            ...
            <motion.h1
              ...
              className="text-[34px] sm:text-[54px] md:text-[68px] lg:text-[72px] font-serif font-normal leading-[1.08] text-[#fbf9f6] tracking-wide mb-6 drop-shadow-md"
            >
              Your Event.
              <br />
              Our Promise.
            ...
            >
              <button className="px-6 py-3.5 rounded-md border border-[#c9973a]/80 bg-[#c9973a] text-[#200e05] font-sans text-sm tracking-wide font-medium hover:bg-[#d7a24d] active:scale-[0.99] transition-all duration-300 shadow-lg text-center cursor-pointer">
